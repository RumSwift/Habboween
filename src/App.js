              ...
              <div className="bg-gray-800 rounded-3xl border-4 border-green-600 p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                      ...
                      className="bg-green-600 text-white font-bold py-2 px-4 rounded-xl hover:bg-green-700 transition-all border-2 border-green-900"
                  >
                    {hideKings ? 'Show Zombie Masters' : 'Hide Zombie Masters'}
                  </button>
                </div>
